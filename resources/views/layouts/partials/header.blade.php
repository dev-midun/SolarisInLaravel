            ...
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="index.html" class="header-logo">
                        <img src="{{ Vite::asset('resources/assets/images/logo/solaris-white-logo.png') }}" alt="logo" class="desktop-logo">
                        <img src="{{ Vite::asset('resources/assets/images/logo/solaris-logo-only.png') }}" alt="logo" class="toggle-logo">
                        <img src="{{ Vite::asset('resources/assets/images/logo/solaris-white-logo.png') }}" alt="logo" class="desktop-white">
                        <img src="{{ Vite::asset('resources/assets/images/logo/solaris-logo-only.png') }}" alt="logo" class="toggle-white">
                        <img src="{{ Vite::asset('resources/assets/images/logo/solaris-dark-logo.png') }}" alt="logo" class="desktop-dark">
                        <img src="{{ Vite::asset('resources/assets/images/logo/solaris-logo-only.png') }}" alt="logo" class="toggle-dark">
                    </a>
                </div>
            </div>
            <!-- End::header-element -->
