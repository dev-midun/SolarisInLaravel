...
export default class LayoutMenu {
    ...
    init() {
                    ...
                    if (parentMenu) {
                        parentMenu.querySelectorAll(":scope > ul > .slide.has-sub > a").forEach((el) => {
                            ...
                            if (
                                ...
                                LayoutMenu.slideUp(el.nextElementSibling);
                            }
                        });
                    }
                    LayoutMenu.slideToggle(element.nextElementSibling);
                }
            });
        });
        ...
        (() => {
            ...
            headerToggleBtn.addEventListener("click", LayoutMenu.toggleSidemenu);
            let mainContent = document.querySelector(".main-content");
            if (window.innerWidth <= 992) {
                mainContent.addEventListener("click", LayoutMenu.menuClose);
            } else {
                mainContent.removeEventListener("click", LayoutMenu.menuClose);
            }

            WindowPreSize = [window.innerWidth];
            LayoutMenu.setNavActive();
            if (
                html.getAttribute("data-nav-layout") === "horizontal" &&
                window.innerWidth >= 992
            ) {
                LayoutMenu.clearNavDropdown();
                mainContent.addEventListener("click", LayoutMenu.clearNavDropdown);
            } else {
                mainContent.removeEventListener("click", LayoutMenu.clearNavDropdown);
            }

            window.addEventListener("resize", LayoutMenu.ResizeMenu);
            LayoutMenu.switcherArrowFn();
            ...
            if (
                ...
                setTimeout(() => {
                    CustomSwitcher.horizontalClickFn();
                }, 1000);
            }
            /* Horizontal End */

            LayoutMenu.toggleSidemenu();
        ...
        window.addEventListener("unload", () => {
            let mainContent = document.querySelector(".main-content");
            mainContent.removeEventListener("click", LayoutMenu.clearNavDropdown);
            window.removeEventListener("resize", LayoutMenu.ResizeMenu);
            let sidemenulink = document.querySelectorAll(".main-menu li > .side-menu__item");
            sidemenulink.forEach((ele) =>
                ele.removeEventListener("click", LayoutMenu.doubleClickFn)
            );
        });
    ...
    static slideUp(target, duration = ANIMATION_DURATION) {
    ...
    static slideDown(target, duration = ANIMATION_DURATION) {
        const { parentElement } = target;
    ...
    static slideToggle(target, duration = ANIMATION_DURATION) {
        let html = document.querySelector("html");
        if (!((html.getAttribute("data-nav-style") === "menu-hover" && 
            html.getAttribute("data-toggled") === "menu-hover-closed" && window.innerWidth >= 992) ||
            ...
            if (window.getComputedStyle(target).display === "none") {
                return LayoutMenu.slideDown(target, duration);
            }

            return LayoutMenu.slideUp(target, duration);
        }
    }
    ...
    static toggleSidemenu() {
        ...
        if (window.innerWidth >= 992) {
            if (sidemenuType === "vertical") {
                sidebar.removeEventListener("mouseenter", LayoutMenu.mouseEntered);
                sidebar.removeEventListener("mouseleave", LayoutMenu.mouseLeave);
                sidebar.removeEventListener("click", LayoutMenu.icontextOpen);
                mainContentDiv.removeEventListener("click", LayoutMenu.icontextClose);
                ...
                switch (verticalStyle) {
                    ...
                    case "overlay":
                        ...
                        if (html.getAttribute("data-toggled") === "icon-overlay-close") {
                            ...
                            if (window.innerWidth >= 992) {
                                ...
                                sidebar.addEventListener("mouseenter", LayoutMenu.mouseEntered);
                                sidebar.addEventListener("mouseleave", LayoutMenu.mouseLeave);
                            } else {
                                sidebar.removeEventListener("mouseenter", LayoutMenu.mouseEntered);
                                sidebar.removeEventListener("mouseleave", LayoutMenu.mouseLeave);
                            }
                    ...
                    case "icontext":
                        ...
                        if (html.getAttribute("data-toggled") === "icon-text-close") {
                            ...
                            if (window.innerWidth >= 992) {
                                sidebar.addEventListener("click", LayoutMenu.icontextOpen);
                                mainContentDiv.addEventListener("click", LayoutMenu.icontextClose);
                            } else {
                                sidebar.removeEventListener("click", LayoutMenu.icontextOpen);
                                mainContentDiv.removeEventListener("click", LayoutMenu.icontextClose);
                            }
    ...
    static icontextClose() {
        let html = document.querySelector("html");
        html.removeAttribute("data-icon-text");
    }
    
    static closedSidemenuFn() {
        let html = document.querySelector("html");
    ...
    static menuhoverFn() {
        ...
        hasSub.forEach((e) => {
            e.addEventListener("mouseenter", LayoutMenu.HoverToggleInnerMenuFn);
            e.addEventListener("mouseleave", LayoutMenu.HoverToggleInnerMenuRemoveForceFn);
        });
        LayoutMenu.toggleSidemenu();
        if (html.getAttribute("data-toggled") === "menu-hover-closed") {
            LayoutMenu.clearNavDropdown();
    ...
    static checkHoriMenu() {
        ...
        if (
            ...
            elements.forEach((e) => {
                if (LayoutMenu.isElementVisible(e)) {
    ...
    static HoverToggleInnerMenuRemoveForceFn(event) {
        let element = event.currentTarget;
        let target = element.querySelector("ul");
        target.classList.remove("force-left");
    }
    
    static HoverToggleInnerMenuFn(event) {
        let html = document.documentElement;
        let element = event.currentTarget;
        let target = element.querySelector("ul");
    ...
    static doublemenu() {
        if (window.innerWidth >= 992) {
            ...
            let sidemenulink = document.querySelectorAll(".main-menu > li > .side-menu__item");
            sidemenulink.forEach((ele) => {
                ele.addEventListener("click", LayoutMenu.doubleClickFn);
            });
        }
    }
    
    static doubleClickFn() {
        var $this = this;
        let html = document.querySelector("html");
